...
var searchPost = {
  ...
  photosUrl: "https://jsonplaceholder.typicode.com/photos?id=",
  googleMapsUrl: "https://maps.google.com/?ll=",
  searchBarInput: document.querySelector(".post-search")
};
...
exports.createUserPostDataPhotoMarkup = createUserPostDataPhotoMarkup;
exports.clearPreviousUserData = clearPreviousUserData;
...
},{"./config":"src/config.js"}],"src/model.js":[function(require,module,exports) {
"use strict";
...
function getUserData(inputValue) {
  fetch("".concat(_config.searchPost.postUrl).concat(inputValue)).then(function (response) {
...
function displayAllData(userPost, postImg, userInfo) {
  (0, _view.createUserPostDataPhotoMarkup)(userPost, userInfo, postImg[0]);
}
},{"./config":"src/config.js","./view":"src/view.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
_config.searchPost.searchBarInput.addEventListener('keypress', search);

function search(element) {
  var key = element.which || element.keyCode;
  var getValue = _config.searchPost.searchBarInput.value;

  if (key === 13) {
    (0, _view.clearPreviousUserData)();
    (0, _model.getUserData)(getValue);
  }
}
},{"./config":"src/config.js","./model":"src/model.js","./view":"src/view.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
